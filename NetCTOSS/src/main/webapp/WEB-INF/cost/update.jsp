...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <!--
            Current Path:/netctoss/update.jsp
            Target Path:/netctoss/saveUpdate.do 
             -->
            <form action="saveUpdate.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" value="0" <c:if test="${cost.costType==1 }">checked</c:if> id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" value="1" ${cost.costType==2?'checked':'' } id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" value="2" <c:if test="${cost.costType==1 }">checked</c:if> id="timeBased" onclick="feeTypeChange(3);" />
