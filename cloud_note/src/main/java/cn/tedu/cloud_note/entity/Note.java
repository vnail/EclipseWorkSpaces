...
public class Note {
	public String cn_note_id;
	public String cn_notebook_id;
	public String cn_user_id;
	public String cn_note_status_id;
	public String cn_note_type_id;
	public String cn_note_title;
	public String cn_note_body;
	public Timestamp cn_note_create_time;
	public Timestamp cn_note_last_modify_time;
